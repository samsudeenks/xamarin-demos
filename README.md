...
Refer [Syncfusion Project Templates](https://help.syncfusion.com/xamarin/visual-studio-integration/visual-studio-extensions/item-templates) for more details.

## <a name="support-and-feedback"></a>Support and Feedback ##

* If you’re interested in Xamarin development using Syncfusion Xamarin UI components, refer the below guides that will help you building your own application.
